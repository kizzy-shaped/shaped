              ...
              >
                ...
                {dropdownVisible && dropdownState.index === id && (
                  <div className="w-[100%] bg-black p-[2em] fixed top-[80px] left-[0vw]">
                    <div className={`w-full grid ${label.toLowerCase() == "fashion" ? 'grid-cols-5':'grid-cols-4'} ${`w-full grid ${label.toLowerCase() == "fashion" ? 'wmin_3xl:gap-x-[1.5em]':'wmin_3xl:gap-x-[2em]'} wmin_3xl:gap-x-[2em] wmin_xl:wmax_3xl:gap-x-[1.5em] justify-between`}>
