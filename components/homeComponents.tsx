      ...
      <Container className="flex items-center">
        <Marquee loop={0} speed={50} className="w-full h-fit flex">
          {[
            ...
            { img: "/images/portfolio/king_charles.jpeg" },
            { img: "/images/portfolio/vogue.jpeg" },
            { img: "/images/portfolio/britain.jpeg" },
            { img: "/images/portfolio/fashion.jpeg" },
            { img: "/images/portfolio/bet_star.jpeg" },
            { img: "/images/portfolio/universal.jpeg" },
            { img: "/images/portfolio/the_fashion.jpeg" },
            { img: "/images/portfolio/nta.jpeg" },
          ].map(({ img }, index) => (
            <img
    ...
    >
      <Container className="h-fit wmin_lg:grid wmin_lg:grid-cols-2 gap-[3em] wmax_lg:flex wmax_lg:flex-col wmin_lg:pt-[11vh] wmax_lg:pt-[3vh]">
        <div className="col-span-1 h-full flex flex-col gap-[32px] justify-center wmax_xl:items-center">
          <div className="wmin_xl:text-[22px] wmax_xl:text-[15px] font-bold text-white wmax_xl:text-center">
